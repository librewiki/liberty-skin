...
class LibertyTemplate extends BaseTemplate {
	...
	protected function loginBox() {
		...
		<div class="navbar-login">
			<?php
			if ( $user->isLoggedIn() ) { // If the user is logged in...
				if ( $wgLibertyUseGravatar ) { // ...and Gravatar is enabled in site config...
					if ( $user->getEmailAuthenticationTimestamp() ) { // ...and the user has a confirmed email...
				...
				if ( class_exists( 'wAvatar' ) ) { // SocialProfile support
