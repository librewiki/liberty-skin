...
class SkinLiberty extends SkinTemplate {
	...
	function setupSkinUserCss( OutputPage $out ) {
		parent::setupSkinUserCss( $out );
			/* 스킨 깨짐 방지 임시조치 */
			$out->addHeadItem( 'maincss', '<link rel="stylesheet" href="//librewiki.net/css/default.css" />' );
			$out->addHeadItem( 'mobilecss', '<link rel="stylesheet" href="//librewiki.net/css/default_mobile.css" />' );
			$out->addHeadItem( 'mobilecss', '<link rel="stylesheet" href="//librewiki.net/css/default_mobile.css" />' );
			$out->addHeadItem( 'onlymwcss', '<link rel="stylesheet" href="//librewiki.net/css/only-mw.css" />' );
			$out->addHeadItem( 'wikitablecss', '<link rel="stylesheet" href="//librewiki.net/css/wiki-table.css" />' );
